package net.woorisys.lighting.config;
...
import net.woorisys.lighting.provider.SaveIdLoginSuccessHandler;
import net.woorisys.lighting.provider.UserAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests() // 요청을 어떻게 보안을 할 것인지 설정
			...
			.antMatchers("/apartment/**").access("hasRole('ROLE_USER')")
		.and()
